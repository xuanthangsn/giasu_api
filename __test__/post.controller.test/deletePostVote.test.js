...
describe("delete post vote", () => {
  ...
  describe("vote not found", () => {
    it("404 status code", async () => {
      ...
      await supertest(app).delete("/api/post/1/1").expect(404);
    });
  });
  ...
  describe("query error", () => {
    it("500 status code", async () => {
      ...
      await supertest(app).delete("/api/post/1/1").expect(500);
    });
  });
});
